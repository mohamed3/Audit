						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									$reseau = mysql_query("SELECT * FROM glpi_scan where DAY(date) like '2' and MONTH(date) like '%".date("n")."%' and Adresse_ip like '%200.1.1%' group by (Adresse_ip)") or die ('erreur SQL '.$query.'<br>'.mysql_error());
									$nbr=0;
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="alert alert-info">
									...
									Liste des Vulnerabilites au niveau de Siege.
								</div>
		...
		<script type="text/javascript">
			...
			[ 
				<?php
					...
					$reponse = mysql_query("SELECT * FROM glpi_scan where MONTH(date) like '%".date("n")."%' and titre_v='Siege' group by (Adresse_ip) order by (date) ") or die ('erreur SQL '.$query.'<br>'.mysql_error());
						...
						while($donnees = mysql_fetch_array($reponse)){
							...
							$reponse1 = mysql_query("SELECT * FROM glpi_scan where MONTH(date) like '%".date("n")."%' and titre_v='Siege' and  Adresse_ip = '".$donnees['Adresse_ip']."'") or die ('erreur SQL '.$query.'<br>'.mysql_error());
							...
							?>
							{
							 ...
							 adresse:"<a href='details.php?ip=<?php echo $donnees['Adresse_ip'];?>&amp;date=<?php echo $donnees['date'];?>&amp;site=siege'><?php echo $donnees['Adresse_ip'];?></a>",
