						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									128.91.50.0 - 255.255.255.0
									<?php
									$con=mysql_connect("200.1.1.22","root","stip2015") or die ("erreur");
									mysql_select_db('glpi855',$con);
					
									$reseau = mysql_query("SELECT * FROM glpi_scan where DAY(date) like '2' and MONTH(date) like '%".date("n")."%' and Adresse_ip like '%128.91.50%' group by (Adresse_ip)") or die ('erreur SQL '.$query.'<br>'.mysql_error());
									$nbr=0;
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="alert alert-info">
									...
									Liste des Vulnerabilites au niveau d'Usine Msaken.
								</div>
...
<![endif]-->
	...
	<?php
					...
					$reponse = mysql_query("SELECT * FROM glpi_scan where MONTH(date) like '%".date("n")."%' and titre_v='Usine Msaken' group by (Adresse_ip) order by (date) ") or die ('erreur SQL '.$query.'<br>'.mysql_error());
						...
						while($donnees = mysql_fetch_array($reponse)){
							...
							$reponse1 = mysql_query("SELECT * FROM glpi_scan where MONTH(date) like '%".date("n")."%' and titre_v='Usine Msaken' and  Adresse_ip = '".$donnees['Adresse_ip']."'") or die ('erreur SQL '.$query.'<br>'.mysql_error());
							...
							{plugin:"<a class='red' href='delete.php?id=<?php echo $donnees['id'];?>'>	<i class='ace-icon fa fa-trash-o bigger-130'></i></a>",
							 ...
							 adresse:"<a href='details.php?ip=<?php echo $donnees['Adresse_ip'];?>&amp;date=<?php echo $donnees['date'];?>&amp;site=ms'><?php echo $donnees['Adresse_ip'];?></a>",
