...
$con=mysql_connect("200.1.1.22","root","stip2015") or die ("erreur");
	...
	$reponse1 = mysql_query("SELECT * FROM glpi_scan where id = '".$id."'") or die ('erreur SQL '.$query.'<br>'.mysql_error());
	$donnees1 = mysql_fetch_array($reponse1);
	
	$repon1 = mysql_query("SELECT * FROM glpi_scan where id = '".$id."'") or die ('erreur SQL '.$query.'<br>'.mysql_error());
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
							<a href=""> <?php echo $donnees1['titre_v'];?></a>
							</li>
							
							<li>
								<a href="details.php?ip=<?php echo $donnees1['Adresse_ip'];?>&amp;date=<?php echo $donnees1['date'];?>&amp;site=<?php echo $donnees1['titre_v'];?>">@ <?php echo $donnees1['Adresse_ip'];?></a>
							</li>
							
							<li>
								<a href=""> Vulnerabilite de plugin N°: <?php echo $donnees1['id_plugin'];?></a>
							</li>
										...
										<div class="widget-box">
											<div class="widget-header">
												<h4 class="smaller">
													...
													<?php echo $donnees1['description_scan'];?>
												</h4>
											</div>
											...
											<div class="widget-body">
												...
												<h2>Description:</h2>
													<p class="muted">
														<?php echo $donnees1['description_v'];?>
													</p>

													<hr>
												<h2>Solution:</h2>	
													<p class="muted">
														<?php echo $donnees1['solution_v'];?>
													</p>
